            ...
            <section class="cate5">
                <aside>
                    ...
                    <ul class="lnb">
                        ...
                        <li class="<%= cate.equals("qna") ? "on" : "off" %>"><a href="/FarmStory/board/list.jsp?group=community&cate=qna">1:1고객문의</a></li>
                        <li class="<%= cate.equals("faq") ? "on" : "off" %>"><a href="/FarmStory/board/list.jsp?group=community&cate=faq">자주묻는질문</a></li>
                    </ul>
